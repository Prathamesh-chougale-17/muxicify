...
import { GenreProps } from "@/sanity/sanity-util";
const TiltGamesCard = ({ name, image, slug }: GenreProps) => {
        ...
        <div className="w-[300px] sm:w-[320px] rounded-2xl lg:m-1">
          ...
          >
            <div className="relative items-end">
              ...
              />
              <h3 className="text-white font-bold text-[24px] text-center rounded-b-2xl bg-gray-600">
                {name}
              </h3>
            </div>
          </Tilt>
